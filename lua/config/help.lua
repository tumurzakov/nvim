...
local vim_text = [[
 ...
 GIT & REVIEW
 gR   Patch review (J/K=file U/D=commit r=run e=edit c=commit A=amend P=push B=rebase X=revert gJ=jira ]q/[q=nav zM/zR=fold)
 :ReviewMR <gitlab-mr-url>  fetch peer MR → gR vs develop  (gJ=view Jira ticket)
